...
export default function GlobalSearchPage() {
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        >
          ...
          <Tabs value={tab} onValueChange={(v) => setTab(v as ViewTab)} className="w-auto">
            <TabsList className="relative inline-flex h-11 items-center gap-1 rounded-xl border border-stone-200/60 bg-white/40 p-1.5 backdrop-blur-md dark:border-neutral-800/60 dark:bg-neutral-950/40">
              <TabsTrigger
                value="lnp"
                className="relative z-10 rounded-lg px-6 py-1.5 text-xs font-medium transition-all data-[state=active]:bg-stone-900 data-[state=active]:text-white data-[state=active]:shadow-lg dark:data-[state=active]:bg-neutral-50 dark:data-[state=active]:text-neutral-900"
              >
                LNP
              </TabsTrigger>
              <TabsTrigger
  ...
  return (
    <div className="mx-auto max-w-[1600px] space-y-6 px-4 py-4">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-stone-200/60 bg-white/40 p-6 backdrop-blur-xl dark:border-neutral-800/60 dark:bg-neutral-950/40">
