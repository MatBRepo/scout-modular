                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            size="icon"
                            variant="outline"
                            className="h-8 w-8 border-gray-300 p-0 transition hover:scale-105 hover:border-gray-400 dark:border-neutral-700"
                            onClick={() => onQuick(r)}
          ...
          <TabsContent value="new" className="mt-2 space-y-4">
            ...
            <div className="rounded-xl border border-gray-200 p-4 dark:border-neutral-800">
              ...
              <div className="grid grid-cols-1 items-center gap-2 sm:grid-cols-[1fr_auto_1fr]">
                ...
                <div className="hidden select-none items-end justify-center pb-2 text-sm text-gray-500 sm:flex">vs</div>
                <div>
                ...
                <div className="sm:hidden text-center text-sm text-gray-500">vs</div>
              </div>
